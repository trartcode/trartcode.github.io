...
const ArticleCard = ({ slug, title, excerpt, date, category, coverImage, index }: ArticleCardProps) => {
  ...
  return (
    <article className={`xuan-paper rounded-xl overflow-hidden border border-paper-300 card-hover cursor-pointer h-full transition-all duration-600 ease-out ${
